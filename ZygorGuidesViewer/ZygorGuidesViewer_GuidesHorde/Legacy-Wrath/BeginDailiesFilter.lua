...
local prefix = "Zygor's Horde Dailies Guides\\"
local categories = {
	["Borean Tundra"] = true,
	["Dalaran"] = true,
	["Dragonblight"] = true,
...
local state = {
	...
	installedWasNil = ZGV.HordeDailiesInstalled == nil,
	installed = ZGV.HordeDailiesInstalled,
...
ZGV._LegacyWrathHordeDailiesFilter = state
ZGV._registrationSource = "legacy-wrath-horde-dailies"
